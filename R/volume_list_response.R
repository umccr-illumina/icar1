#' Create a new VolumeListResponse
#'
#' @description
...
#' @description VolumeListResponse Class
#' @format An \code{R6Class} generator object
#' @field items Items in paged list list(\link{VolumeResponse}) [optional]
...
VolumeListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    `totalItemCount` = NULL,
    `totalPageCount` = NULL,
    #' Initialize a new VolumeListResponse class.
    #'
    #' @description
    #' Initialize a new VolumeListResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return VolumeListResponse in JSON format
    #' @export
    toJSON = function() {
      VolumeListResponseObject <- list()
      if (!is.null(self$`items`)) {
        VolumeListResponseObject[["items"]] <-
          lapply(self$`items`, function(x) x$toJSON())
      }
      if (!is.null(self$`itemCount`)) {
        VolumeListResponseObject[["itemCount"]] <-
          self$`itemCount`
      }
      if (!is.null(self$`firstPageToken`)) {
        VolumeListResponseObject[["firstPageToken"]] <-
          self$`firstPageToken`
      }
      if (!is.null(self$`nextPageToken`)) {
        VolumeListResponseObject[["nextPageToken"]] <-
          self$`nextPageToken`
      }
      if (!is.null(self$`prevPageToken`)) {
        VolumeListResponseObject[["prevPageToken"]] <-
          self$`prevPageToken`
      }
      if (!is.null(self$`lastPageToken`)) {
        VolumeListResponseObject[["lastPageToken"]] <-
          self$`lastPageToken`
      }
      if (!is.null(self$`totalItemCount`)) {
        VolumeListResponseObject[["totalItemCount"]] <-
          self$`totalItemCount`
      }
      if (!is.null(self$`totalPageCount`)) {
        VolumeListResponseObject[["totalPageCount"]] <-
          self$`totalPageCount`
      }
      VolumeListResponseObject
    },
    #' Deserialize JSON string into an instance of VolumeListResponse
    #'
    #' @description
    #' Deserialize JSON string into an instance of VolumeListResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of VolumeListResponse
    #' @export
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`items`)) {
        self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[VolumeResponse]", loadNamespace("icar1"))
      }
...
',
    ...
    #' Validate JSON input with respect to VolumeListResponse
    #'
    #' @description
    #' Validate JSON input with respect to VolumeListResponse and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of VolumeListResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# VolumeListResponse$unlock()
#
## Below is an example to define the print function
# VolumeListResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# VolumeListResponse$lock()
