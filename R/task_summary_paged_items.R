#' Create a new TaskSummaryPagedItems
#'
#' @description
#' TaskSummaryPagedItems Class
#'
#' @docType class
#' @title TaskSummaryPagedItems
#' @description TaskSummaryPagedItems Class
#' @format An \code{R6Class} generator object
#' @field items  list(\link{TaskSummary}) [optional]
...
#' @export
TaskSummaryPagedItems <- R6::R6Class(
  ...
  public = list(
    ...
    `totalItemCount` = NULL,
    `totalPageCount` = NULL,
    #' Initialize a new TaskSummaryPagedItems class.
    #'
    #' @description
    #' Initialize a new TaskSummaryPagedItems class.
    #'
    ...
    #' To JSON String
    #'
    #' @return TaskSummaryPagedItems in JSON format
    #' @export
    toJSON = function() {
      TaskSummaryPagedItemsObject <- list()
      if (!is.null(self$`items`)) {
        TaskSummaryPagedItemsObject[["items"]] <-
          lapply(self$`items`, function(x) x$toJSON())
      }
      if (!is.null(self$`itemCount`)) {
        TaskSummaryPagedItemsObject[["itemCount"]] <-
          self$`itemCount`
      }
      if (!is.null(self$`firstPageToken`)) {
        TaskSummaryPagedItemsObject[["firstPageToken"]] <-
          self$`firstPageToken`
      }
      if (!is.null(self$`nextPageToken`)) {
        TaskSummaryPagedItemsObject[["nextPageToken"]] <-
          self$`nextPageToken`
      }
      if (!is.null(self$`prevPageToken`)) {
        TaskSummaryPagedItemsObject[["prevPageToken"]] <-
          self$`prevPageToken`
      }
      if (!is.null(self$`lastPageToken`)) {
        TaskSummaryPagedItemsObject[["lastPageToken"]] <-
          self$`lastPageToken`
      }
      if (!is.null(self$`totalItemCount`)) {
        TaskSummaryPagedItemsObject[["totalItemCount"]] <-
          self$`totalItemCount`
      }
      if (!is.null(self$`totalPageCount`)) {
        TaskSummaryPagedItemsObject[["totalPageCount"]] <-
          self$`totalPageCount`
      }
      TaskSummaryPagedItemsObject
    },
    #' Deserialize JSON string into an instance of TaskSummaryPagedItems
    #'
    #' @description
    #' Deserialize JSON string into an instance of TaskSummaryPagedItems
    #'
    #' @param input_json the JSON input
    #' @return the instance of TaskSummaryPagedItems
    #' @export
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`items`)) {
        self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[TaskSummary]", loadNamespace("icar1"))
      }
...
',
    ...
    #' Validate JSON input with respect to TaskSummaryPagedItems
    #'
    #' @description
    #' Validate JSON input with respect to TaskSummaryPagedItems and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of TaskSummaryPagedItems
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# TaskSummaryPagedItems$unlock()
#
## Below is an example to define the print function
# TaskSummaryPagedItems$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# TaskSummaryPagedItems$lock()
