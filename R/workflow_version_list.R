#' Create a new WorkflowVersionList
#'
#' @description
#' WorkflowVersionList Class
#'
#' @docType class
#' @title WorkflowVersionList
#' @description WorkflowVersionList Class
#' @format An \code{R6Class} generator object
#' @field items Items in paged list list(\link{WorkflowVersionCompact}) [optional]
...
#' @export
WorkflowVersionList <- R6::R6Class(
  "WorkflowVersionList",
  public = list(
    `items` = NULL,
    `itemCount` = NULL,
    ...
    `totalItemCount` = NULL,
    `totalPageCount` = NULL,
    #' Initialize a new WorkflowVersionList class.
    #'
    #' @description
    #' Initialize a new WorkflowVersionList class.
    #'
    ...
    #' To JSON String
    #'
    #' @return WorkflowVersionList in JSON format
    #' @export
    toJSON = function() {
      WorkflowVersionListObject <- list()
      if (!is.null(self$`items`)) {
        WorkflowVersionListObject[["items"]] <-
          lapply(self$`items`, function(x) x$toJSON())
      }
      if (!is.null(self$`itemCount`)) {
        WorkflowVersionListObject[["itemCount"]] <-
          self$`itemCount`
      }
      if (!is.null(self$`firstPageToken`)) {
        WorkflowVersionListObject[["firstPageToken"]] <-
          self$`firstPageToken`
      }
      if (!is.null(self$`nextPageToken`)) {
        WorkflowVersionListObject[["nextPageToken"]] <-
          self$`nextPageToken`
      }
      if (!is.null(self$`prevPageToken`)) {
        WorkflowVersionListObject[["prevPageToken"]] <-
          self$`prevPageToken`
      }
      if (!is.null(self$`lastPageToken`)) {
        WorkflowVersionListObject[["lastPageToken"]] <-
          self$`lastPageToken`
      }
      if (!is.null(self$`totalItemCount`)) {
        WorkflowVersionListObject[["totalItemCount"]] <-
          self$`totalItemCount`
      }
      if (!is.null(self$`totalPageCount`)) {
        WorkflowVersionListObject[["totalPageCount"]] <-
          self$`totalPageCount`
      }
      WorkflowVersionListObject
    },
    #' Deserialize JSON string into an instance of WorkflowVersionList
    #'
    #' @description
    #' Deserialize JSON string into an instance of WorkflowVersionList
    #'
    #' @param input_json the JSON input
    #' @return the instance of WorkflowVersionList
    #' @export
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`items`)) {
        self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[WorkflowVersionCompact]", loadNamespace("icar1"))
      }
...
',
    ...
    #' Validate JSON input with respect to WorkflowVersionList
    #'
    #' @description
    #' Validate JSON input with respect to WorkflowVersionList and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of WorkflowVersionList
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# WorkflowVersionList$unlock()
#
## Below is an example to define the print function
# WorkflowVersionList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# WorkflowVersionList$lock()
