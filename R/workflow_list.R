...
#' @docType class
#' @title WorkflowList
#' @description WorkflowList Class
#' @format An \code{R6Class} generator object
#' @field items Items in paged list list(\link{WorkflowCompact}) [optional]
...
WorkflowList <- R6::R6Class(
  ...
  public = list(
    ...
    `totalItemCount` = NULL,
    `totalPageCount` = NULL,
    #' Initialize a new WorkflowList class.
    #'
    #' @description
    #' Initialize a new WorkflowList class.
    #'
    ...
    #' To JSON String
    #'
    #' @return WorkflowList in JSON format
    #' @export
    toJSON = function() {
      WorkflowListObject <- list()
      if (!is.null(self$`items`)) {
        WorkflowListObject[["items"]] <-
          lapply(self$`items`, function(x) x$toJSON())
      }
      if (!is.null(self$`itemCount`)) {
        WorkflowListObject[["itemCount"]] <-
          self$`itemCount`
      }
      if (!is.null(self$`firstPageToken`)) {
        WorkflowListObject[["firstPageToken"]] <-
          self$`firstPageToken`
      }
      if (!is.null(self$`nextPageToken`)) {
        WorkflowListObject[["nextPageToken"]] <-
          self$`nextPageToken`
      }
      if (!is.null(self$`prevPageToken`)) {
        WorkflowListObject[["prevPageToken"]] <-
          self$`prevPageToken`
      }
      if (!is.null(self$`lastPageToken`)) {
        WorkflowListObject[["lastPageToken"]] <-
          self$`lastPageToken`
      }
      if (!is.null(self$`totalItemCount`)) {
        WorkflowListObject[["totalItemCount"]] <-
          self$`totalItemCount`
      }
      if (!is.null(self$`totalPageCount`)) {
        WorkflowListObject[["totalPageCount"]] <-
          self$`totalPageCount`
      }
      WorkflowListObject
    },
    #' Deserialize JSON string into an instance of WorkflowList
    #'
    #' @description
    #' Deserialize JSON string into an instance of WorkflowList
    #'
    #' @param input_json the JSON input
    #' @return the instance of WorkflowList
    #' @export
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`items`)) {
        self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[WorkflowCompact]", loadNamespace("icar1"))
      }
...
',
    ...
    #' Validate JSON input with respect to WorkflowList
    #'
    #' @description
    #' Validate JSON input with respect to WorkflowList and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of WorkflowList
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# WorkflowList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
