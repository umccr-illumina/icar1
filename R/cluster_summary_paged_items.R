#' Create a new ClusterSummaryPagedItems
#'
#' @description
#' ClusterSummaryPagedItems Class
#'
#' @docType class
#' @title ClusterSummaryPagedItems
#' @description ClusterSummaryPagedItems Class
#' @format An \code{R6Class} generator object
#' @field items  list(\link{ClusterSummary}) [optional]
...
#' @export
ClusterSummaryPagedItems <- R6::R6Class(
  ...
  public = list(
    ...
    `totalItemCount` = NULL,
    `totalPageCount` = NULL,
    #' Initialize a new ClusterSummaryPagedItems class.
    #'
    #' @description
    #' Initialize a new ClusterSummaryPagedItems class.
    #'
    ...
    #' To JSON String
    #'
    #' @return ClusterSummaryPagedItems in JSON format
    #' @export
    toJSON = function() {
      ClusterSummaryPagedItemsObject <- list()
      if (!is.null(self$`items`)) {
        ClusterSummaryPagedItemsObject[["items"]] <-
          lapply(self$`items`, function(x) x$toJSON())
      }
      if (!is.null(self$`itemCount`)) {
        ClusterSummaryPagedItemsObject[["itemCount"]] <-
          self$`itemCount`
      }
      if (!is.null(self$`firstPageToken`)) {
        ClusterSummaryPagedItemsObject[["firstPageToken"]] <-
          self$`firstPageToken`
      }
      if (!is.null(self$`nextPageToken`)) {
        ClusterSummaryPagedItemsObject[["nextPageToken"]] <-
          self$`nextPageToken`
      }
      if (!is.null(self$`prevPageToken`)) {
        ClusterSummaryPagedItemsObject[["prevPageToken"]] <-
          self$`prevPageToken`
      }
      if (!is.null(self$`lastPageToken`)) {
        ClusterSummaryPagedItemsObject[["lastPageToken"]] <-
          self$`lastPageToken`
      }
      if (!is.null(self$`totalItemCount`)) {
        ClusterSummaryPagedItemsObject[["totalItemCount"]] <-
          self$`totalItemCount`
      }
      if (!is.null(self$`totalPageCount`)) {
        ClusterSummaryPagedItemsObject[["totalPageCount"]] <-
          self$`totalPageCount`
      }
      ClusterSummaryPagedItemsObject
    },
    #' Deserialize JSON string into an instance of ClusterSummaryPagedItems
    #'
    #' @description
    #' Deserialize JSON string into an instance of ClusterSummaryPagedItems
    #'
    #' @param input_json the JSON input
    #' @return the instance of ClusterSummaryPagedItems
    #' @export
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`items`)) {
        self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[ClusterSummary]", loadNamespace("icar1"))
      }
...
',
    ...
    #' Validate JSON input with respect to ClusterSummaryPagedItems
    #'
    #' @description
    #' Validate JSON input with respect to ClusterSummaryPagedItems and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of ClusterSummaryPagedItems
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# ClusterSummaryPagedItems$unlock()
#
## Below is an example to define the print function
# ClusterSummaryPagedItems$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ClusterSummaryPagedItems$lock()
