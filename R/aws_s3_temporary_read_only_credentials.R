#' Create a new AwsS3TemporaryReadOnlyCredentials
#'
#' @description
#' AwsS3TemporaryReadOnlyCredentials Class
#'
#' @docType class
#' @title AwsS3TemporaryReadOnlyCredentials
#' @description AwsS3TemporaryReadOnlyCredentials Class
...
#' @export
AwsS3TemporaryReadOnlyCredentials <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new AwsS3TemporaryReadOnlyCredentials class.
    #'
    #' @description
    #' Initialize a new AwsS3TemporaryReadOnlyCredentials class.
    #'
    ...
    #' To JSON String
    #'
    #' @return AwsS3TemporaryReadOnlyCredentials in JSON format
    #' @export
    toJSON = function() {
      AwsS3TemporaryReadOnlyCredentialsObject <- list()
      if (!is.null(self$`access_Key_Id`)) {
        AwsS3TemporaryReadOnlyCredentialsObject[["access_Key_Id"]] <-
          self$`access_Key_Id`
      }
      if (!is.null(self$`secret_Access_Key`)) {
        AwsS3TemporaryReadOnlyCredentialsObject[["secret_Access_Key"]] <-
          self$`secret_Access_Key`
      }
      if (!is.null(self$`session_Token`)) {
        AwsS3TemporaryReadOnlyCredentialsObject[["session_Token"]] <-
          self$`session_Token`
      }
      if (!is.null(self$`region`)) {
        AwsS3TemporaryReadOnlyCredentialsObject[["region"]] <-
          self$`region`
      }
      if (!is.null(self$`bucketName`)) {
        AwsS3TemporaryReadOnlyCredentialsObject[["bucketName"]] <-
          self$`bucketName`
      }
      if (!is.null(self$`keyPrefix`)) {
        AwsS3TemporaryReadOnlyCredentialsObject[["keyPrefix"]] <-
          self$`keyPrefix`
      }
      if (!is.null(self$`expirationDate`)) {
        AwsS3TemporaryReadOnlyCredentialsObject[["expirationDate"]] <-
          self$`expirationDate`
      }
      if (!is.null(self$`serviceUrl`)) {
        AwsS3TemporaryReadOnlyCredentialsObject[["serviceUrl"]] <-
          self$`serviceUrl`
      }
      if (!is.null(self$`serverSideEncryptionAlgorithm`)) {
        AwsS3TemporaryReadOnlyCredentialsObject[["serverSideEncryptionAlgorithm"]] <-
          self$`serverSideEncryptionAlgorithm`
      }
      if (!is.null(self$`serverSideEncryptionKey`)) {
        AwsS3TemporaryReadOnlyCredentialsObject[["serverSideEncryptionKey"]] <-
          self$`serverSideEncryptionKey`
      }
      AwsS3TemporaryReadOnlyCredentialsObject
    },
    #' Deserialize JSON string into an instance of AwsS3TemporaryReadOnlyCredentials
    #'
    #' @description
    #' Deserialize JSON string into an instance of AwsS3TemporaryReadOnlyCredentials
    #'
    #' @param input_json the JSON input
    #' @return the instance of AwsS3TemporaryReadOnlyCredentials
    #' @export
    ...
    #' Validate JSON input with respect to AwsS3TemporaryReadOnlyCredentials
    #'
    #' @description
    #' Validate JSON input with respect to AwsS3TemporaryReadOnlyCredentials and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of AwsS3TemporaryReadOnlyCredentials
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# AwsS3TemporaryReadOnlyCredentials$unlock()
#
## Below is an example to define the print function
# AwsS3TemporaryReadOnlyCredentials$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AwsS3TemporaryReadOnlyCredentials$lock()
