#' Create a new FolderListResponse
#'
#' @description
...
#' @description FolderListResponse Class
#' @format An \code{R6Class} generator object
#' @field items Items in paged list list(\link{FolderResponse}) [optional]
...
FolderListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    `totalItemCount` = NULL,
    `totalPageCount` = NULL,
    #' Initialize a new FolderListResponse class.
    #'
    #' @description
    #' Initialize a new FolderListResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return FolderListResponse in JSON format
    #' @export
    toJSON = function() {
      FolderListResponseObject <- list()
      if (!is.null(self$`items`)) {
        FolderListResponseObject[["items"]] <-
          lapply(self$`items`, function(x) x$toJSON())
      }
      if (!is.null(self$`itemCount`)) {
        FolderListResponseObject[["itemCount"]] <-
          self$`itemCount`
      }
      if (!is.null(self$`firstPageToken`)) {
        FolderListResponseObject[["firstPageToken"]] <-
          self$`firstPageToken`
      }
      if (!is.null(self$`nextPageToken`)) {
        FolderListResponseObject[["nextPageToken"]] <-
          self$`nextPageToken`
      }
      if (!is.null(self$`prevPageToken`)) {
        FolderListResponseObject[["prevPageToken"]] <-
          self$`prevPageToken`
      }
      if (!is.null(self$`lastPageToken`)) {
        FolderListResponseObject[["lastPageToken"]] <-
          self$`lastPageToken`
      }
      if (!is.null(self$`totalItemCount`)) {
        FolderListResponseObject[["totalItemCount"]] <-
          self$`totalItemCount`
      }
      if (!is.null(self$`totalPageCount`)) {
        FolderListResponseObject[["totalPageCount"]] <-
          self$`totalPageCount`
      }
      FolderListResponseObject
    },
    #' Deserialize JSON string into an instance of FolderListResponse
    #'
    #' @description
    #' Deserialize JSON string into an instance of FolderListResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of FolderListResponse
    #' @export
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`items`)) {
        self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[FolderResponse]", loadNamespace("icar1"))
      }
...
',
    ...
    #' Validate JSON input with respect to FolderListResponse
    #'
    #' @description
    #' Validate JSON input with respect to FolderListResponse and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of FolderListResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# FolderListResponse$unlock()
#
## Below is an example to define the print function
# FolderListResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# FolderListResponse$lock()
