#' Create a new WorkflowVersionCompact
#'
#' @description
#' Compact details of a Workflow version definition
#'
#' @docType class
#' @title WorkflowVersionCompact
#' @description WorkflowVersionCompact Class
...
#' @export
WorkflowVersionCompact <- R6::R6Class(
  ...
  public = list(
    ...
    `tenantId` = NULL,
    `acl` = NULL,
    #' Initialize a new WorkflowVersionCompact class.
    #'
    #' @description
    #' Initialize a new WorkflowVersionCompact class.
    #'
    ...
    #' @export
    initialize = function(`id` = NULL, `urn` = NULL, `href` = NULL, `version` = NULL, `category` = NULL, `description` = NULL, `language` = NULL, `status` = NULL, `createdByClientId` = NULL, `timeCreated` = NULL, `timeModified` = NULL, `createdBy` = NULL, `modifiedBy` = NULL, `tenantId` = NULL, `acl` = NULL, ...) {
      if (!is.null(`id`)) {
    ...
    #' To JSON String
    #'
    #' @return WorkflowVersionCompact in JSON format
    #' @export
    toJSON = function() {
      WorkflowVersionCompactObject <- list()
      if (!is.null(self$`id`)) {
        WorkflowVersionCompactObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`urn`)) {
        WorkflowVersionCompactObject[["urn"]] <-
          self$`urn`
      }
      if (!is.null(self$`href`)) {
        WorkflowVersionCompactObject[["href"]] <-
          self$`href`
      }
      if (!is.null(self$`version`)) {
        WorkflowVersionCompactObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`category`)) {
        WorkflowVersionCompactObject[["category"]] <-
          self$`category`
      }
      if (!is.null(self$`description`)) {
        WorkflowVersionCompactObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`language`)) {
        WorkflowVersionCompactObject[["language"]] <-
          self$`language`$toJSON()
      }
      if (!is.null(self$`status`)) {
        WorkflowVersionCompactObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`createdByClientId`)) {
        WorkflowVersionCompactObject[["createdByClientId"]] <-
          self$`createdByClientId`
      }
      if (!is.null(self$`timeCreated`)) {
        WorkflowVersionCompactObject[["timeCreated"]] <-
          self$`timeCreated`
      }
      if (!is.null(self$`timeModified`)) {
        WorkflowVersionCompactObject[["timeModified"]] <-
          self$`timeModified`
      }
      if (!is.null(self$`createdBy`)) {
        WorkflowVersionCompactObject[["createdBy"]] <-
          self$`createdBy`
      }
      if (!is.null(self$`modifiedBy`)) {
        WorkflowVersionCompactObject[["modifiedBy"]] <-
          self$`modifiedBy`
      }
      if (!is.null(self$`tenantId`)) {
        WorkflowVersionCompactObject[["tenantId"]] <-
          self$`tenantId`
      }
      if (!is.null(self$`acl`)) {
        WorkflowVersionCompactObject[["acl"]] <-
          self$`acl`
      }
      WorkflowVersionCompactObject
    },
    #' Deserialize JSON string into an instance of WorkflowVersionCompact
    #'
    #' @description
    #' Deserialize JSON string into an instance of WorkflowVersionCompact
    #'
    #' @param input_json the JSON input
    #' @return the instance of WorkflowVersionCompact
    #' @export
    ...
    #' Validate JSON input with respect to WorkflowVersionCompact
    #'
    #' @description
    #' Validate JSON input with respect to WorkflowVersionCompact and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of WorkflowVersionCompact
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# WorkflowVersionCompact$unlock()
#
## Below is an example to define the print function
# WorkflowVersionCompact$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# WorkflowVersionCompact$lock()
