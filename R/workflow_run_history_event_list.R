#' Create a new WorkflowRunHistoryEventList
#'
#' @description
#' WorkflowRunHistoryEventList Class
#'
#' @docType class
#' @title WorkflowRunHistoryEventList
#' @description WorkflowRunHistoryEventList Class
#' @format An \code{R6Class} generator object
#' @field items Items in paged list list(\link{WorkflowRunHistoryEvent}) [optional]
...
#' @export
WorkflowRunHistoryEventList <- R6::R6Class(
  ...
  public = list(
    ...
    `totalItemCount` = NULL,
    `totalPageCount` = NULL,
    #' Initialize a new WorkflowRunHistoryEventList class.
    #'
    #' @description
    #' Initialize a new WorkflowRunHistoryEventList class.
    #'
    ...
    #' To JSON String
    #'
    #' @return WorkflowRunHistoryEventList in JSON format
    #' @export
    toJSON = function() {
      WorkflowRunHistoryEventListObject <- list()
      if (!is.null(self$`items`)) {
        WorkflowRunHistoryEventListObject[["items"]] <-
          lapply(self$`items`, function(x) x$toJSON())
      }
      if (!is.null(self$`itemCount`)) {
        WorkflowRunHistoryEventListObject[["itemCount"]] <-
          self$`itemCount`
      }
      if (!is.null(self$`firstPageToken`)) {
        WorkflowRunHistoryEventListObject[["firstPageToken"]] <-
          self$`firstPageToken`
      }
      if (!is.null(self$`nextPageToken`)) {
        WorkflowRunHistoryEventListObject[["nextPageToken"]] <-
          self$`nextPageToken`
      }
      if (!is.null(self$`prevPageToken`)) {
        WorkflowRunHistoryEventListObject[["prevPageToken"]] <-
          self$`prevPageToken`
      }
      if (!is.null(self$`lastPageToken`)) {
        WorkflowRunHistoryEventListObject[["lastPageToken"]] <-
          self$`lastPageToken`
      }
      if (!is.null(self$`totalItemCount`)) {
        WorkflowRunHistoryEventListObject[["totalItemCount"]] <-
          self$`totalItemCount`
      }
      if (!is.null(self$`totalPageCount`)) {
        WorkflowRunHistoryEventListObject[["totalPageCount"]] <-
          self$`totalPageCount`
      }
      WorkflowRunHistoryEventListObject
    },
    #' Deserialize JSON string into an instance of WorkflowRunHistoryEventList
    #'
    #' @description
    #' Deserialize JSON string into an instance of WorkflowRunHistoryEventList
    #'
    #' @param input_json the JSON input
    #' @return the instance of WorkflowRunHistoryEventList
    #' @export
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`items`)) {
        self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[WorkflowRunHistoryEvent]", loadNamespace("icar1"))
      }
...
',
    ...
    #' Validate JSON input with respect to WorkflowRunHistoryEventList
    #'
    #' @description
    #' Validate JSON input with respect to WorkflowRunHistoryEventList and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of WorkflowRunHistoryEventList
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# WorkflowRunHistoryEventList$unlock()
#
## Below is an example to define the print function
# WorkflowRunHistoryEventList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# WorkflowRunHistoryEventList$lock()
