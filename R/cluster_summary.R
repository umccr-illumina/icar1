...
#' @description ClusterSummary Class
...
ClusterSummary <- R6::R6Class(
  ...
  public = list(
    ...
    `modifiedBy` = NULL,
    `timeModified` = NULL,
    #' Initialize a new ClusterSummary class.
    #'
    #' @description
    #' Initialize a new ClusterSummary class.
    #'
    ...
    #' To JSON String
    #'
    #' @return ClusterSummary in JSON format
    #' @export
    toJSON = function() {
      ClusterSummaryObject <- list()
      if (!is.null(self$`id`)) {
        ClusterSummaryObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`href`)) {
        ClusterSummaryObject[["href"]] <-
          self$`href`
      }
      if (!is.null(self$`urn`)) {
        ClusterSummaryObject[["urn"]] <-
          self$`urn`
      }
      if (!is.null(self$`name`)) {
        ClusterSummaryObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`svcAcctUId`)) {
        ClusterSummaryObject[["svcAcctUId"]] <-
          self$`svcAcctUId`
      }
      if (!is.null(self$`status`)) {
        ClusterSummaryObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`type`)) {
        ClusterSummaryObject[["type"]] <-
          self$`type`
      }
      if (!is.null(self$`taskRuns`)) {
        ClusterSummaryObject[["taskRuns"]] <-
          lapply(self$`taskRuns`, function(x) x$toJSON())
      }
      if (!is.null(self$`acl`)) {
        ClusterSummaryObject[["acl"]] <-
          self$`acl`
      }
      if (!is.null(self$`tenantId`)) {
        ClusterSummaryObject[["tenantId"]] <-
          self$`tenantId`
      }
      if (!is.null(self$`subTenantId`)) {
        ClusterSummaryObject[["subTenantId"]] <-
          self$`subTenantId`
      }
      if (!is.null(self$`createdBy`)) {
        ClusterSummaryObject[["createdBy"]] <-
          self$`createdBy`
      }
      if (!is.null(self$`timeCreated`)) {
        ClusterSummaryObject[["timeCreated"]] <-
          self$`timeCreated`
      }
      if (!is.null(self$`modifiedBy`)) {
        ClusterSummaryObject[["modifiedBy"]] <-
          self$`modifiedBy`
      }
      if (!is.null(self$`timeModified`)) {
        ClusterSummaryObject[["timeModified"]] <-
          self$`timeModified`
      }
      ClusterSummaryObject
    },
    #' Deserialize JSON string into an instance of ClusterSummary
    #'
    #' @description
    #' Deserialize JSON string into an instance of ClusterSummary
    #'
    #' @param input_json the JSON input
    #' @return the instance of ClusterSummary
    #' @export
...
',
    ...
    #' Validate JSON input with respect to ClusterSummary
    #'
    #' @description
    #' Validate JSON input with respect to ClusterSummary and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of ClusterSummary
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# ClusterSummary$unlock()
#
## Below is an example to define the print function
# ClusterSummary$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
