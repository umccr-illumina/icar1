#' Create a new CreateTaskVersionRequest
#'
#' @description
#' CreateTaskVersionRequest Class
#'
#' @docType class
#' @title CreateTaskVersionRequest
#' @description CreateTaskVersionRequest Class
#' @format An \code{R6Class} generator object
#' @field version User-defined version of task version character
...
#' @export
CreateTaskVersionRequest <- R6::R6Class(
  ...
  public = list(
    ...
    `execution` = NULL,
    `acl` = NULL,
    #' Initialize a new CreateTaskVersionRequest class.
    #'
    #' @description
    #' Initialize a new CreateTaskVersionRequest class.
    #'
    ...
    #' @export
    initialize = function(`version`, `description` = NULL, `execution` = NULL, `acl` = NULL, ...) {
      if (!missing(`version`)) {
    ...
    #' To JSON String
    #'
    #' @return CreateTaskVersionRequest in JSON format
    #' @export
    toJSON = function() {
      CreateTaskVersionRequestObject <- list()
      if (!is.null(self$`version`)) {
        CreateTaskVersionRequestObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`description`)) {
        CreateTaskVersionRequestObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`execution`)) {
        CreateTaskVersionRequestObject[["execution"]] <-
          self$`execution`$toJSON()
      }
      if (!is.null(self$`acl`)) {
        CreateTaskVersionRequestObject[["acl"]] <-
          self$`acl`
      }
      CreateTaskVersionRequestObject
    },
    #' Deserialize JSON string into an instance of CreateTaskVersionRequest
    #'
    #' @description
    #' Deserialize JSON string into an instance of CreateTaskVersionRequest
    #'
    #' @param input_json the JSON input
    #' @return the instance of CreateTaskVersionRequest
    #' @export
    ...
    #' Validate JSON input with respect to CreateTaskVersionRequest
    #'
    #' @description
    #' Validate JSON input with respect to CreateTaskVersionRequest and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`version`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CreateTaskVersionRequest: the required field `version` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of CreateTaskVersionRequest
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# CreateTaskVersionRequest$unlock()
#
## Below is an example to define the print function
# CreateTaskVersionRequest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CreateTaskVersionRequest$lock()
