#' Create a new WorkflowSignalList
#'
#' @description
#' WorkflowSignalList Class
#'
#' @docType class
#' @title WorkflowSignalList
#' @description WorkflowSignalList Class
#' @format An \code{R6Class} generator object
#' @field items Items in paged list list(\link{WorkflowSignalCompact}) [optional]
...
WorkflowSignalList <- R6::R6Class(
  ...
  public = list(
    ...
    `totalItemCount` = NULL,
    `totalPageCount` = NULL,
    #' Initialize a new WorkflowSignalList class.
    #'
    #' @description
    #' Initialize a new WorkflowSignalList class.
    #'
    ...
    #' To JSON String
    #'
    #' @return WorkflowSignalList in JSON format
    #' @export
    toJSON = function() {
      WorkflowSignalListObject <- list()
      if (!is.null(self$`items`)) {
        WorkflowSignalListObject[["items"]] <-
          lapply(self$`items`, function(x) x$toJSON())
      }
      if (!is.null(self$`itemCount`)) {
        WorkflowSignalListObject[["itemCount"]] <-
          self$`itemCount`
      }
      if (!is.null(self$`firstPageToken`)) {
        WorkflowSignalListObject[["firstPageToken"]] <-
          self$`firstPageToken`
      }
      if (!is.null(self$`nextPageToken`)) {
        WorkflowSignalListObject[["nextPageToken"]] <-
          self$`nextPageToken`
      }
      if (!is.null(self$`prevPageToken`)) {
        WorkflowSignalListObject[["prevPageToken"]] <-
          self$`prevPageToken`
      }
      if (!is.null(self$`lastPageToken`)) {
        WorkflowSignalListObject[["lastPageToken"]] <-
          self$`lastPageToken`
      }
      if (!is.null(self$`totalItemCount`)) {
        WorkflowSignalListObject[["totalItemCount"]] <-
          self$`totalItemCount`
      }
      if (!is.null(self$`totalPageCount`)) {
        WorkflowSignalListObject[["totalPageCount"]] <-
          self$`totalPageCount`
      }
      WorkflowSignalListObject
    },
    #' Deserialize JSON string into an instance of WorkflowSignalList
    #'
    #' @description
    #' Deserialize JSON string into an instance of WorkflowSignalList
    #'
    #' @param input_json the JSON input
    #' @return the instance of WorkflowSignalList
    #' @export
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`items`)) {
        self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[WorkflowSignalCompact]", loadNamespace("icar1"))
      }
...
',
    ...
    #' Validate JSON input with respect to WorkflowSignalList
    #'
    #' @description
    #' Validate JSON input with respect to WorkflowSignalList and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of WorkflowSignalList
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# WorkflowSignalList$unlock()
#
## Below is an example to define the print function
# WorkflowSignalList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# WorkflowSignalList$lock()
