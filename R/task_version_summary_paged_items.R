#' Create a new TaskVersionSummaryPagedItems
#'
#' @description
#' TaskVersionSummaryPagedItems Class
#'
#' @docType class
#' @title TaskVersionSummaryPagedItems
#' @description TaskVersionSummaryPagedItems Class
#' @format An \code{R6Class} generator object
#' @field items  list(\link{TaskVersionSummary}) [optional]
...
#' @export
TaskVersionSummaryPagedItems <- R6::R6Class(
  ...
  public = list(
    ...
    `totalItemCount` = NULL,
    `totalPageCount` = NULL,
    #' Initialize a new TaskVersionSummaryPagedItems class.
    #'
    #' @description
    #' Initialize a new TaskVersionSummaryPagedItems class.
    #'
    ...
    #' To JSON String
    #'
    #' @return TaskVersionSummaryPagedItems in JSON format
    #' @export
    toJSON = function() {
      TaskVersionSummaryPagedItemsObject <- list()
      if (!is.null(self$`items`)) {
        TaskVersionSummaryPagedItemsObject[["items"]] <-
          lapply(self$`items`, function(x) x$toJSON())
      }
      if (!is.null(self$`itemCount`)) {
        TaskVersionSummaryPagedItemsObject[["itemCount"]] <-
          self$`itemCount`
      }
      if (!is.null(self$`firstPageToken`)) {
        TaskVersionSummaryPagedItemsObject[["firstPageToken"]] <-
          self$`firstPageToken`
      }
      if (!is.null(self$`nextPageToken`)) {
        TaskVersionSummaryPagedItemsObject[["nextPageToken"]] <-
          self$`nextPageToken`
      }
      if (!is.null(self$`prevPageToken`)) {
        TaskVersionSummaryPagedItemsObject[["prevPageToken"]] <-
          self$`prevPageToken`
      }
      if (!is.null(self$`lastPageToken`)) {
        TaskVersionSummaryPagedItemsObject[["lastPageToken"]] <-
          self$`lastPageToken`
      }
      if (!is.null(self$`totalItemCount`)) {
        TaskVersionSummaryPagedItemsObject[["totalItemCount"]] <-
          self$`totalItemCount`
      }
      if (!is.null(self$`totalPageCount`)) {
        TaskVersionSummaryPagedItemsObject[["totalPageCount"]] <-
          self$`totalPageCount`
      }
      TaskVersionSummaryPagedItemsObject
    },
    #' Deserialize JSON string into an instance of TaskVersionSummaryPagedItems
    #'
    #' @description
    #' Deserialize JSON string into an instance of TaskVersionSummaryPagedItems
    #'
    #' @param input_json the JSON input
    #' @return the instance of TaskVersionSummaryPagedItems
    #' @export
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`items`)) {
        self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[TaskVersionSummary]", loadNamespace("icar1"))
      }
...
',
    ...
    #' Validate JSON input with respect to TaskVersionSummaryPagedItems
    #'
    #' @description
    #' Validate JSON input with respect to TaskVersionSummaryPagedItems and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of TaskVersionSummaryPagedItems
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# TaskVersionSummaryPagedItems$unlock()
#
## Below is an example to define the print function
# TaskVersionSummaryPagedItems$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# TaskVersionSummaryPagedItems$lock()
