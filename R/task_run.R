...
TaskRun <- R6::R6Class(
  ...
  public = list(
    ...
    `modifiedBy` = NULL,
    `timeModified` = NULL,
    #' Initialize a new TaskRun class.
    #'
    #' @description
    #' Initialize a new TaskRun class.
    #'
    ...
    #' @export
    initialize = function(`id` = NULL, `href` = NULL, `urn` = NULL, `name` = NULL, `description` = NULL, `status` = "Pending", `statusDetails` = NULL, `typeOfResource` = NULL, `sizeOfResource` = NULL, `tierOfResource` = NULL, `execution` = NULL, `taskVersionSummary` = NULL, `logs` = NULL, `executionRawJson` = NULL, `acl` = NULL, `tenantId` = NULL, `subTenantId` = NULL, `createdBy` = NULL, `timeCreated` = NULL, `modifiedBy` = NULL, `timeModified` = NULL, ...) {
      if (!is.null(`id`)) {
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`description`)) {
        TaskRunObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`status`)) {
        TaskRunObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`statusDetails`)) {
        TaskRunObject[["statusDetails"]] <-
          self$`statusDetails`
      }
      if (!is.null(self$`typeOfResource`)) {
        TaskRunObject[["typeOfResource"]] <-
          self$`typeOfResource`
      }
      if (!is.null(self$`sizeOfResource`)) {
        TaskRunObject[["sizeOfResource"]] <-
          self$`sizeOfResource`
      }
      if (!is.null(self$`tierOfResource`)) {
        TaskRunObject[["tierOfResource"]] <-
          self$`tierOfResource`
      }
      if (!is.null(self$`execution`)) {
        TaskRunObject[["execution"]] <-
          self$`execution`$toJSON()
      }
      if (!is.null(self$`taskVersionSummary`)) {
        TaskRunObject[["taskVersionSummary"]] <-
      ...
      if (!is.null(self$`executionRawJson`)) {
        TaskRunObject[["executionRawJson"]] <-
      ...
      if (!is.null(self$`tenantId`)) {
        TaskRunObject[["tenantId"]] <-
          self$`tenantId`
      }
      if (!is.null(self$`subTenantId`)) {
        TaskRunObject[["subTenantId"]] <-
          self$`subTenantId`
      }
      if (!is.null(self$`createdBy`)) {
        TaskRunObject[["createdBy"]] <-
          self$`createdBy`
      }
      if (!is.null(self$`timeCreated`)) {
        TaskRunObject[["timeCreated"]] <-
          self$`timeCreated`
      }
      if (!is.null(self$`modifiedBy`)) {
        TaskRunObject[["modifiedBy"]] <-
          self$`modifiedBy`
      }
      if (!is.null(self$`timeModified`)) {
        TaskRunObject[["timeModified"]] <-
          self$`timeModified`
      }
      TaskRunObject
    },
    #' Deserialize JSON string into an instance of TaskRun
    #'
    #' @description
    #' Deserialize JSON string into an instance of TaskRun
    #'
    #' @param input_json the JSON input
    #' @return the instance of TaskRun
    #' @export
...
',
    ...
    #' Validate JSON input with respect to TaskRun
    #'
    #' @description
    #' Validate JSON input with respect to TaskRun and throw an exception if invalid
    #'
...
# TaskRun$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
