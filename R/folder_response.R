...
#' @description FolderResponse Class
...
FolderResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new FolderResponse class.
    #'
    #' @description
    #' Initialize a new FolderResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return FolderResponse in JSON format
    #' @export
    toJSON = function() {
      FolderResponseObject <- list()
      if (!is.null(self$`id`)) {
        FolderResponseObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`name`)) {
        FolderResponseObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`volumeId`)) {
        FolderResponseObject[["volumeId"]] <-
          self$`volumeId`
      }
      if (!is.null(self$`parentFolderId`)) {
        FolderResponseObject[["parentFolderId"]] <-
          self$`parentFolderId`
      }
      if (!is.null(self$`volumeName`)) {
        FolderResponseObject[["volumeName"]] <-
          self$`volumeName`
      }
      if (!is.null(self$`tenantId`)) {
        FolderResponseObject[["tenantId"]] <-
          self$`tenantId`
      }
      if (!is.null(self$`subTenantId`)) {
        FolderResponseObject[["subTenantId"]] <-
          self$`subTenantId`
      }
      if (!is.null(self$`urn`)) {
        FolderResponseObject[["urn"]] <-
          self$`urn`
      }
      if (!is.null(self$`path`)) {
        FolderResponseObject[["path"]] <-
          self$`path`
      }
      if (!is.null(self$`acl`)) {
        FolderResponseObject[["acl"]] <-
          self$`acl`
      }
      if (!is.null(self$`inheritedAcl`)) {
        FolderResponseObject[["inheritedAcl"]] <-
          self$`inheritedAcl`
      }
      if (!is.null(self$`timeCreated`)) {
        FolderResponseObject[["timeCreated"]] <-
          self$`timeCreated`
      }
      if (!is.null(self$`createdBy`)) {
        FolderResponseObject[["createdBy"]] <-
          self$`createdBy`
      }
      if (!is.null(self$`timeModified`)) {
        FolderResponseObject[["timeModified"]] <-
          self$`timeModified`
      }
      if (!is.null(self$`modifiedBy`)) {
        FolderResponseObject[["modifiedBy"]] <-
          self$`modifiedBy`
      }
      if (!is.null(self$`metadata`)) {
        FolderResponseObject[["metadata"]] <-
          self$`metadata`
      }
      if (!is.null(self$`volumeMetadata`)) {
        FolderResponseObject[["volumeMetadata"]] <-
          self$`volumeMetadata`
      }
      if (!is.null(self$`jobStatus`)) {
        FolderResponseObject[["jobStatus"]] <-
          self$`jobStatus`
      }
      if (!is.null(self$`jobId`)) {
        FolderResponseObject[["jobId"]] <-
          self$`jobId`
      }
      if (!is.null(self$`archiveJobStorageTier`)) {
        FolderResponseObject[["archiveJobStorageTier"]] <-
          self$`archiveJobStorageTier`
      }
      if (!is.null(self$`migrationStatus`)) {
        FolderResponseObject[["migrationStatus"]] <-
          self$`migrationStatus`
      }
      if (!is.null(self$`activeJobIds`)) {
        FolderResponseObject[["activeJobIds"]] <-
          self$`activeJobIds`
      }
      if (!is.null(self$`objectStoreAccess`)) {
        FolderResponseObject[["objectStoreAccess"]] <-
          self$`objectStoreAccess`$toJSON()
      }
      FolderResponseObject
    },
    #' Deserialize JSON string into an instance of FolderResponse
    #'
    #' @description
    #' Deserialize JSON string into an instance of FolderResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of FolderResponse
    #' @export
    ...
    #' Validate JSON input with respect to FolderResponse
    #'
    #' @description
    #' Validate JSON input with respect to FolderResponse and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of FolderResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# FolderResponse$unlock()
#
## Below is an example to define the print function
# FolderResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
