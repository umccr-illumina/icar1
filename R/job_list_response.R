...
#' @field items Items in paged list list(\link{JobResponse}) [optional]
...
JobListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    `totalItemCount` = NULL,
    `totalPageCount` = NULL,
    #' Initialize a new JobListResponse class.
    #'
    #' @description
    #' Initialize a new JobListResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return JobListResponse in JSON format
    #' @export
    toJSON = function() {
      JobListResponseObject <- list()
      if (!is.null(self$`items`)) {
        JobListResponseObject[["items"]] <-
          lapply(self$`items`, function(x) x$toJSON())
      }
      if (!is.null(self$`itemCount`)) {
        JobListResponseObject[["itemCount"]] <-
          self$`itemCount`
      }
      if (!is.null(self$`firstPageToken`)) {
        JobListResponseObject[["firstPageToken"]] <-
          self$`firstPageToken`
      }
      if (!is.null(self$`nextPageToken`)) {
        JobListResponseObject[["nextPageToken"]] <-
          self$`nextPageToken`
      }
      if (!is.null(self$`prevPageToken`)) {
        JobListResponseObject[["prevPageToken"]] <-
          self$`prevPageToken`
      }
      if (!is.null(self$`lastPageToken`)) {
        JobListResponseObject[["lastPageToken"]] <-
          self$`lastPageToken`
      }
      if (!is.null(self$`totalItemCount`)) {
        JobListResponseObject[["totalItemCount"]] <-
          self$`totalItemCount`
      }
      if (!is.null(self$`totalPageCount`)) {
        JobListResponseObject[["totalPageCount"]] <-
          self$`totalPageCount`
      }
      JobListResponseObject
    },
    #' Deserialize JSON string into an instance of JobListResponse
    #'
    #' @description
    #' Deserialize JSON string into an instance of JobListResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of JobListResponse
    #' @export
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`items`)) {
        self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[JobResponse]", loadNamespace("icar1"))
      }
...
',
    ...
    #' Validate JSON input with respect to JobListResponse
    #'
    #' @description
    #' Validate JSON input with respect to JobListResponse and throw an exception if invalid
    #'
...
# JobListResponse$unlock()
#
## Below is an example to define the print function
# JobListResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# JobListResponse$lock()
