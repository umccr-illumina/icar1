...
#' @description WorkflowRunList Class
#' @format An \code{R6Class} generator object
#' @field items Items in paged list list(\link{WorkflowRunCompact}) [optional]
...
WorkflowRunList <- R6::R6Class(
  ...
  public = list(
    ...
    `totalItemCount` = NULL,
    `totalPageCount` = NULL,
    #' Initialize a new WorkflowRunList class.
    #'
    #' @description
    #' Initialize a new WorkflowRunList class.
    #'
    ...
    #' To JSON String
    #'
    #' @return WorkflowRunList in JSON format
    #' @export
    toJSON = function() {
      WorkflowRunListObject <- list()
      if (!is.null(self$`items`)) {
        WorkflowRunListObject[["items"]] <-
          lapply(self$`items`, function(x) x$toJSON())
      }
      if (!is.null(self$`itemCount`)) {
        WorkflowRunListObject[["itemCount"]] <-
          self$`itemCount`
      }
      if (!is.null(self$`firstPageToken`)) {
        WorkflowRunListObject[["firstPageToken"]] <-
          self$`firstPageToken`
      }
      if (!is.null(self$`nextPageToken`)) {
        WorkflowRunListObject[["nextPageToken"]] <-
          self$`nextPageToken`
      }
      if (!is.null(self$`prevPageToken`)) {
        WorkflowRunListObject[["prevPageToken"]] <-
          self$`prevPageToken`
      }
      if (!is.null(self$`lastPageToken`)) {
        WorkflowRunListObject[["lastPageToken"]] <-
          self$`lastPageToken`
      }
      if (!is.null(self$`totalItemCount`)) {
        WorkflowRunListObject[["totalItemCount"]] <-
          self$`totalItemCount`
      }
      if (!is.null(self$`totalPageCount`)) {
        WorkflowRunListObject[["totalPageCount"]] <-
          self$`totalPageCount`
      }
      WorkflowRunListObject
    },
    #' Deserialize JSON string into an instance of WorkflowRunList
    #'
    #' @description
    #' Deserialize JSON string into an instance of WorkflowRunList
    #'
    #' @param input_json the JSON input
    #' @return the instance of WorkflowRunList
    #' @export
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`items`)) {
        self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[WorkflowRunCompact]", loadNamespace("icar1"))
      }
...
',
    ...
    #' Validate JSON input with respect to WorkflowRunList
    #'
    #' @description
    #' Validate JSON input with respect to WorkflowRunList and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of WorkflowRunList
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# WorkflowRunList$unlock()
#
## Below is an example to define the print function
# WorkflowRunList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# WorkflowRunList$lock()
