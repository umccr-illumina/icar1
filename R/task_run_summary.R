#' Create a new TaskRunSummary
#'
#' @description
#' TaskRunSummary Class
#'
#' @docType class
#' @title TaskRunSummary
#' @description TaskRunSummary Class
...
TaskRunSummary <- R6::R6Class(
  ...
  public = list(
    ...
    `modifiedBy` = NULL,
    `timeModified` = NULL,
    #' Initialize a new TaskRunSummary class.
    #'
    #' @description
    #' Initialize a new TaskRunSummary class.
    #'
    ...
    #' @export
    initialize = function(`id` = NULL, `href` = NULL, `urn` = NULL, `name` = NULL, `description` = NULL, `status` = "Pending", `statusDetails` = NULL, `typeOfResource` = NULL, `sizeOfResource` = NULL, `tierOfResource` = NULL, `taskVersionSummary` = NULL, `acl` = NULL, `tenantId` = NULL, `subTenantId` = NULL, `createdBy` = NULL, `timeCreated` = NULL, `modifiedBy` = NULL, `timeModified` = NULL, ...) {
      if (!is.null(`id`)) {
    ...
    #' To JSON String
    #'
    #' @return TaskRunSummary in JSON format
    #' @export
    toJSON = function() {
      TaskRunSummaryObject <- list()
      if (!is.null(self$`id`)) {
        TaskRunSummaryObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`href`)) {
        TaskRunSummaryObject[["href"]] <-
          self$`href`
      }
      if (!is.null(self$`urn`)) {
        TaskRunSummaryObject[["urn"]] <-
          self$`urn`
      }
      if (!is.null(self$`name`)) {
        TaskRunSummaryObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`description`)) {
        TaskRunSummaryObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`status`)) {
        TaskRunSummaryObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`statusDetails`)) {
        TaskRunSummaryObject[["statusDetails"]] <-
          self$`statusDetails`
      }
      if (!is.null(self$`typeOfResource`)) {
        TaskRunSummaryObject[["typeOfResource"]] <-
          self$`typeOfResource`
      }
      if (!is.null(self$`sizeOfResource`)) {
        TaskRunSummaryObject[["sizeOfResource"]] <-
          self$`sizeOfResource`
      }
      if (!is.null(self$`tierOfResource`)) {
        TaskRunSummaryObject[["tierOfResource"]] <-
          self$`tierOfResource`
      }
      if (!is.null(self$`taskVersionSummary`)) {
        TaskRunSummaryObject[["taskVersionSummary"]] <-
          self$`taskVersionSummary`$toJSON()
      }
      if (!is.null(self$`acl`)) {
        TaskRunSummaryObject[["acl"]] <-
          self$`acl`
      }
      if (!is.null(self$`tenantId`)) {
        TaskRunSummaryObject[["tenantId"]] <-
          self$`tenantId`
      }
      if (!is.null(self$`subTenantId`)) {
        TaskRunSummaryObject[["subTenantId"]] <-
          self$`subTenantId`
      }
      if (!is.null(self$`createdBy`)) {
        TaskRunSummaryObject[["createdBy"]] <-
          self$`createdBy`
      }
      if (!is.null(self$`timeCreated`)) {
        TaskRunSummaryObject[["timeCreated"]] <-
          self$`timeCreated`
      }
      if (!is.null(self$`modifiedBy`)) {
        TaskRunSummaryObject[["modifiedBy"]] <-
          self$`modifiedBy`
      }
      if (!is.null(self$`timeModified`)) {
        TaskRunSummaryObject[["timeModified"]] <-
          self$`timeModified`
      }
      TaskRunSummaryObject
    },
    #' Deserialize JSON string into an instance of TaskRunSummary
    #'
    #' @description
    #' Deserialize JSON string into an instance of TaskRunSummary
    #'
    #' @param input_json the JSON input
    #' @return the instance of TaskRunSummary
    #' @export
    ...
    #' Validate JSON input with respect to TaskRunSummary
    #'
    #' @description
    #' Validate JSON input with respect to TaskRunSummary and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of TaskRunSummary
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# TaskRunSummary$unlock()
#
## Below is an example to define the print function
# TaskRunSummary$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
