#' Create a new WorkflowSignalCompact
#'
#' @description
#' Compact details of a signal
#'
#' @docType class
#' @title WorkflowSignalCompact
#' @description WorkflowSignalCompact Class
...
#' @export
WorkflowSignalCompact <- R6::R6Class(
  ...
  public = list(
    ...
    `tenantId` = NULL,
    `acl` = NULL,
    #' Initialize a new WorkflowSignalCompact class.
    #'
    #' @description
    #' Initialize a new WorkflowSignalCompact class.
    #'
    ...
    #' To JSON String
    #'
    #' @return WorkflowSignalCompact in JSON format
    #' @export
    toJSON = function() {
      WorkflowSignalCompactObject <- list()
      if (!is.null(self$`id`)) {
        WorkflowSignalCompactObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`urn`)) {
        WorkflowSignalCompactObject[["urn"]] <-
          self$`urn`
      }
      if (!is.null(self$`href`)) {
        WorkflowSignalCompactObject[["href"]] <-
          self$`href`
      }
      if (!is.null(self$`sendHeartbeatHref`)) {
        WorkflowSignalCompactObject[["sendHeartbeatHref"]] <-
          self$`sendHeartbeatHref`
      }
      if (!is.null(self$`sendSuccessResponseHref`)) {
        WorkflowSignalCompactObject[["sendSuccessResponseHref"]] <-
          self$`sendSuccessResponseHref`
      }
      if (!is.null(self$`sendFailureResponseHref`)) {
        WorkflowSignalCompactObject[["sendFailureResponseHref"]] <-
          self$`sendFailureResponseHref`
      }
      if (!is.null(self$`name`)) {
        WorkflowSignalCompactObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`status`)) {
        WorkflowSignalCompactObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`type`)) {
        WorkflowSignalCompactObject[["type"]] <-
          self$`type`
      }
      if (!is.null(self$`description`)) {
        WorkflowSignalCompactObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`inputs`)) {
        WorkflowSignalCompactObject[["inputs"]] <-
          self$`inputs`
      }
      if (!is.null(self$`workflowRun`)) {
        WorkflowSignalCompactObject[["workflowRun"]] <-
          self$`workflowRun`$toJSON()
      }
      if (!is.null(self$`timeoutSeconds`)) {
        WorkflowSignalCompactObject[["timeoutSeconds"]] <-
          self$`timeoutSeconds`
      }
      if (!is.null(self$`result`)) {
        WorkflowSignalCompactObject[["result"]] <-
          self$`result`
      }
      if (!is.null(self$`error`)) {
        WorkflowSignalCompactObject[["error"]] <-
          self$`error`
      }
      if (!is.null(self$`errorCause`)) {
        WorkflowSignalCompactObject[["errorCause"]] <-
          self$`errorCause`
      }
      if (!is.null(self$`createdByClientId`)) {
        WorkflowSignalCompactObject[["createdByClientId"]] <-
          self$`createdByClientId`
      }
      if (!is.null(self$`timeCreated`)) {
        WorkflowSignalCompactObject[["timeCreated"]] <-
          self$`timeCreated`
      }
      if (!is.null(self$`timeModified`)) {
        WorkflowSignalCompactObject[["timeModified"]] <-
          self$`timeModified`
      }
      if (!is.null(self$`createdBy`)) {
        WorkflowSignalCompactObject[["createdBy"]] <-
          self$`createdBy`
      }
      if (!is.null(self$`modifiedBy`)) {
        WorkflowSignalCompactObject[["modifiedBy"]] <-
          self$`modifiedBy`
      }
      if (!is.null(self$`tenantId`)) {
        WorkflowSignalCompactObject[["tenantId"]] <-
          self$`tenantId`
      }
      if (!is.null(self$`acl`)) {
        WorkflowSignalCompactObject[["acl"]] <-
          self$`acl`
      }
      WorkflowSignalCompactObject
    },
    #' Deserialize JSON string into an instance of WorkflowSignalCompact
    #'
    #' @description
    #' Deserialize JSON string into an instance of WorkflowSignalCompact
    #'
    #' @param input_json the JSON input
    #' @return the instance of WorkflowSignalCompact
    #' @export
    ...
    #' Validate JSON input with respect to WorkflowSignalCompact
    #'
    #' @description
    #' Validate JSON input with respect to WorkflowSignalCompact and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of WorkflowSignalCompact
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# WorkflowSignalCompact$unlock()
#
## Below is an example to define the print function
# WorkflowSignalCompact$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# WorkflowSignalCompact$lock()
