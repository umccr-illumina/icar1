#' Create a new VolumeConfigurationListResponse
#'
#' @description
#' VolumeConfigurationListResponse Class
#'
#' @docType class
#' @title VolumeConfigurationListResponse
#' @description VolumeConfigurationListResponse Class
#' @format An \code{R6Class} generator object
#' @field items Items in paged list list(\link{VolumeConfigurationResponse}) [optional]
...
#' @export
VolumeConfigurationListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    `totalItemCount` = NULL,
    `totalPageCount` = NULL,
    #' Initialize a new VolumeConfigurationListResponse class.
    #'
    #' @description
    #' Initialize a new VolumeConfigurationListResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return VolumeConfigurationListResponse in JSON format
    #' @export
    toJSON = function() {
      VolumeConfigurationListResponseObject <- list()
      if (!is.null(self$`items`)) {
        VolumeConfigurationListResponseObject[["items"]] <-
          lapply(self$`items`, function(x) x$toJSON())
      }
      if (!is.null(self$`itemCount`)) {
        VolumeConfigurationListResponseObject[["itemCount"]] <-
          self$`itemCount`
      }
      if (!is.null(self$`firstPageToken`)) {
        VolumeConfigurationListResponseObject[["firstPageToken"]] <-
          self$`firstPageToken`
      }
      if (!is.null(self$`nextPageToken`)) {
        VolumeConfigurationListResponseObject[["nextPageToken"]] <-
          self$`nextPageToken`
      }
      if (!is.null(self$`prevPageToken`)) {
        VolumeConfigurationListResponseObject[["prevPageToken"]] <-
          self$`prevPageToken`
      }
      if (!is.null(self$`lastPageToken`)) {
        VolumeConfigurationListResponseObject[["lastPageToken"]] <-
          self$`lastPageToken`
      }
      if (!is.null(self$`totalItemCount`)) {
        VolumeConfigurationListResponseObject[["totalItemCount"]] <-
          self$`totalItemCount`
      }
      if (!is.null(self$`totalPageCount`)) {
        VolumeConfigurationListResponseObject[["totalPageCount"]] <-
          self$`totalPageCount`
      }
      VolumeConfigurationListResponseObject
    },
    #' Deserialize JSON string into an instance of VolumeConfigurationListResponse
    #'
    #' @description
    #' Deserialize JSON string into an instance of VolumeConfigurationListResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of VolumeConfigurationListResponse
    #' @export
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`items`)) {
        self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[VolumeConfigurationResponse]", loadNamespace("icar1"))
      }
...
',
    ...
    #' Validate JSON input with respect to VolumeConfigurationListResponse
    #'
    #' @description
    #' Validate JSON input with respect to VolumeConfigurationListResponse and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of VolumeConfigurationListResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# VolumeConfigurationListResponse$unlock()
#
## Below is an example to define the print function
# VolumeConfigurationListResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# VolumeConfigurationListResponse$lock()
