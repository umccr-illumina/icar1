...
#' @description SessionResponse Class
...
SessionResponse <- R6::R6Class(
  ...
  public = list(
    ...
    `timeCompleted` = NULL,
    `metadata` = NULL,
    #' Initialize a new SessionResponse class.
    #'
    #' @description
    #' Initialize a new SessionResponse class.
    #'
    ...
    #' @export
    initialize = function(`id` = NULL, `folderUrn` = NULL, `status` = NULL, `timeCreated` = NULL, `timeCredentialsExpire` = NULL, `timeClosed` = NULL, `timeCompleted` = NULL, `metadata` = NULL, ...) {
      if (!is.null(`id`)) {
    ...
    #' To JSON String
    #'
    #' @return SessionResponse in JSON format
    #' @export
    toJSON = function() {
      SessionResponseObject <- list()
      if (!is.null(self$`id`)) {
        SessionResponseObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`folderUrn`)) {
        SessionResponseObject[["folderUrn"]] <-
          self$`folderUrn`
      }
      ...
      if (!is.null(self$`timeCredentialsExpire`)) {
        SessionResponseObject[["timeCredentialsExpire"]] <-
          self$`timeCredentialsExpire`
      }
      if (!is.null(self$`timeClosed`)) {
        SessionResponseObject[["timeClosed"]] <-
          self$`timeClosed`
      }
      if (!is.null(self$`timeCompleted`)) {
        SessionResponseObject[["timeCompleted"]] <-
          self$`timeCompleted`
      }
      if (!is.null(self$`metadata`)) {
        SessionResponseObject[["metadata"]] <-
          self$`metadata`
      }
      SessionResponseObject
    },
    #' Deserialize JSON string into an instance of SessionResponse
    #'
    #' @description
    #' Deserialize JSON string into an instance of SessionResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of SessionResponse
    #' @export
    ...
    #' Validate JSON input with respect to SessionResponse
    #'
    #' @description
    #' Validate JSON input with respect to SessionResponse and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of SessionResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# SessionResponse$unlock()
#
## Below is an example to define the print function
# SessionResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# SessionResponse$lock()
