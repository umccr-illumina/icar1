#' Create a new CreateWorkflowVersionRequest
#'
#' @description
#' Create a new workflow version under an existing workflow root
#'
#' @docType class
#' @title CreateWorkflowVersionRequest
#' @description CreateWorkflowVersionRequest Class
...
#' @export
CreateWorkflowVersionRequest <- R6::R6Class(
  ...
  public = list(
    ...
    `acl` = NULL,
    `status` = NULL,
    #' Initialize a new CreateWorkflowVersionRequest class.
    #'
    #' @description
    #' Initialize a new CreateWorkflowVersionRequest class.
    #'
    ...
    #' @export
    initialize = function(`version`, `description` = NULL, `language` = NULL, `definition` = NULL, `acl` = NULL, `status` = NULL, ...) {
      if (!missing(`version`)) {
    ...
    #' To JSON String
    #'
    #' @return CreateWorkflowVersionRequest in JSON format
    #' @export
    toJSON = function() {
      CreateWorkflowVersionRequestObject <- list()
      if (!is.null(self$`version`)) {
        CreateWorkflowVersionRequestObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`description`)) {
        CreateWorkflowVersionRequestObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`language`)) {
        CreateWorkflowVersionRequestObject[["language"]] <-
          self$`language`$toJSON()
      }
      if (!is.null(self$`definition`)) {
        CreateWorkflowVersionRequestObject[["definition"]] <-
          self$`definition`
      }
      if (!is.null(self$`acl`)) {
        CreateWorkflowVersionRequestObject[["acl"]] <-
          self$`acl`
      }
      if (!is.null(self$`status`)) {
        CreateWorkflowVersionRequestObject[["status"]] <-
          self$`status`
      }
      CreateWorkflowVersionRequestObject
    },
    #' Deserialize JSON string into an instance of CreateWorkflowVersionRequest
    #'
    #' @description
    #' Deserialize JSON string into an instance of CreateWorkflowVersionRequest
    #'
    #' @param input_json the JSON input
    #' @return the instance of CreateWorkflowVersionRequest
    #' @export
    ...
    #' Validate JSON input with respect to CreateWorkflowVersionRequest
    #'
    #' @description
    #' Validate JSON input with respect to CreateWorkflowVersionRequest and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`version`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CreateWorkflowVersionRequest: the required field `version` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of CreateWorkflowVersionRequest
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# CreateWorkflowVersionRequest$unlock()
#
## Below is an example to define the print function
# CreateWorkflowVersionRequest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CreateWorkflowVersionRequest$lock()
