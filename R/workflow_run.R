...
#' @field input Input to workflow run, as JSON object [optional]
#' @field output Output from workflow run, as JSON object [optional]
...
WorkflowRun <- R6::R6Class(
  ...
  public = list(
    ...
    `tenantId` = NULL,
    `acl` = NULL,
    #' Initialize a new WorkflowRun class.
    #'
    #' @description
    #' Initialize a new WorkflowRun class.
    #'
    ...
    #' @param input Input to workflow run, as JSON
    #' @param output Output from workflow run, as JSON
    ...
    #' @export
    initialize = function(`id` = NULL, `urn` = NULL, `href` = NULL, `name` = NULL, `timeStarted` = NULL, `timeStopped` = NULL, `status` = NULL, `idempotencyKey` = NULL, `statusSummary` = NULL, `error` = NULL, `errorCause` = NULL, `workflowVersion` = NULL, `createdByClientId` = NULL, `input` = NULL, `output` = NULL, `definition` = NULL, `engineParameters` = NULL, `timeCreated` = NULL, `timeModified` = NULL, `createdBy` = NULL, `modifiedBy` = NULL, `tenantId` = NULL, `acl` = NULL, ...) {
      if (!is.null(`id`)) {
    ...
    #' To JSON String
    #'
    #' @return WorkflowRun in JSON format
    #' @export
    toJSON = function() {
      WorkflowRunObject <- list()
      if (!is.null(self$`id`)) {
        WorkflowRunObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`urn`)) {
        WorkflowRunObject[["urn"]] <-
          self$`urn`
      }
      if (!is.null(self$`href`)) {
        WorkflowRunObject[["href"]] <-
          self$`href`
      }
      if (!is.null(self$`name`)) {
        WorkflowRunObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`timeStarted`)) {
        WorkflowRunObject[["timeStarted"]] <-
          self$`timeStarted`
      }
      if (!is.null(self$`timeStopped`)) {
        WorkflowRunObject[["timeStopped"]] <-
          self$`timeStopped`
      }
      if (!is.null(self$`status`)) {
        WorkflowRunObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`idempotencyKey`)) {
        WorkflowRunObject[["idempotencyKey"]] <-
          self$`idempotencyKey`
      }
      if (!is.null(self$`statusSummary`)) {
        WorkflowRunObject[["statusSummary"]] <-
          self$`statusSummary`
      }
      if (!is.null(self$`error`)) {
        WorkflowRunObject[["error"]] <-
          self$`error`
      }
      if (!is.null(self$`errorCause`)) {
        WorkflowRunObject[["errorCause"]] <-
          self$`errorCause`
      }
      if (!is.null(self$`workflowVersion`)) {
        WorkflowRunObject[["workflowVersion"]] <-
          self$`workflowVersion`$toJSON()
      }
      if (!is.null(self$`createdByClientId`)) {
        WorkflowRunObject[["createdByClientId"]] <-
          self$`createdByClientId`
      }
      if (!is.null(self$`input`)) {
        WorkflowRunObject[["input"]] <-
          self$`input`
      }
      if (!is.null(self$`output`)) {
        WorkflowRunObject[["output"]] <-
          self$`output`
      }
      if (!is.null(self$`definition`)) {
        WorkflowRunObject[["definition"]] <-
          self$`definition`
      }
      if (!is.null(self$`engineParameters`)) {
        WorkflowRunObject[["engineParameters"]] <-
          self$`engineParameters`
      }
      if (!is.null(self$`timeCreated`)) {
        WorkflowRunObject[["timeCreated"]] <-
          self$`timeCreated`
      }
      if (!is.null(self$`timeModified`)) {
        WorkflowRunObject[["timeModified"]] <-
          self$`timeModified`
      }
      if (!is.null(self$`createdBy`)) {
        WorkflowRunObject[["createdBy"]] <-
          self$`createdBy`
      }
      if (!is.null(self$`modifiedBy`)) {
        WorkflowRunObject[["modifiedBy"]] <-
          self$`modifiedBy`
      }
      if (!is.null(self$`tenantId`)) {
        WorkflowRunObject[["tenantId"]] <-
          self$`tenantId`
      }
      if (!is.null(self$`acl`)) {
        WorkflowRunObject[["acl"]] <-
          self$`acl`
      }
      WorkflowRunObject
    },
    #' Deserialize JSON string into an instance of WorkflowRun
    #'
    #' @description
    #' Deserialize JSON string into an instance of WorkflowRun
    #'
    #' @param input_json the JSON input
    #' @return the instance of WorkflowRun
    #' @export
    ...
    #' Validate JSON input with respect to WorkflowRun
    #'
    #' @description
    #' Validate JSON input with respect to WorkflowRun and throw an exception if invalid
    #'
...
# WorkflowRun$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
