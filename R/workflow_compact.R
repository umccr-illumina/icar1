#' Create a new WorkflowCompact
#'
#' @description
#' Compact details of a workflow
#'
#' @docType class
#' @title WorkflowCompact
#' @description WorkflowCompact Class
...
WorkflowCompact <- R6::R6Class(
  ...
  public = list(
    ...
    `tenantId` = NULL,
    `acl` = NULL,
    #' Initialize a new WorkflowCompact class.
    #'
    #' @description
    #' Initialize a new WorkflowCompact class.
    #'
    ...
    #' To JSON String
    #'
    #' @return WorkflowCompact in JSON format
    #' @export
    toJSON = function() {
      WorkflowCompactObject <- list()
      if (!is.null(self$`id`)) {
        WorkflowCompactObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`urn`)) {
        WorkflowCompactObject[["urn"]] <-
          self$`urn`
      }
      if (!is.null(self$`href`)) {
        WorkflowCompactObject[["href"]] <-
          self$`href`
      }
      if (!is.null(self$`name`)) {
        WorkflowCompactObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`organization`)) {
        WorkflowCompactObject[["organization"]] <-
          self$`organization`
      }
      if (!is.null(self$`description`)) {
        WorkflowCompactObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`toolClass`)) {
        WorkflowCompactObject[["toolClass"]] <-
          self$`toolClass`
      }
      if (!is.null(self$`categories`)) {
        WorkflowCompactObject[["categories"]] <-
          self$`categories`
      }
      if (!is.null(self$`createdByClientId`)) {
        WorkflowCompactObject[["createdByClientId"]] <-
          self$`createdByClientId`
      }
      if (!is.null(self$`timeCreated`)) {
        WorkflowCompactObject[["timeCreated"]] <-
          self$`timeCreated`
      }
      if (!is.null(self$`timeModified`)) {
        WorkflowCompactObject[["timeModified"]] <-
          self$`timeModified`
      }
      if (!is.null(self$`createdBy`)) {
        WorkflowCompactObject[["createdBy"]] <-
          self$`createdBy`
      }
      if (!is.null(self$`modifiedBy`)) {
        WorkflowCompactObject[["modifiedBy"]] <-
          self$`modifiedBy`
      }
      if (!is.null(self$`tenantId`)) {
        WorkflowCompactObject[["tenantId"]] <-
          self$`tenantId`
      }
      if (!is.null(self$`acl`)) {
        WorkflowCompactObject[["acl"]] <-
          self$`acl`
      }
      WorkflowCompactObject
    },
    #' Deserialize JSON string into an instance of WorkflowCompact
    #'
    #' @description
    #' Deserialize JSON string into an instance of WorkflowCompact
    #'
    #' @param input_json the JSON input
    #' @return the instance of WorkflowCompact
    #' @export
    ...
    #' Validate JSON input with respect to WorkflowCompact
    #'
    #' @description
    #' Validate JSON input with respect to WorkflowCompact and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of WorkflowCompact
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# WorkflowCompact$unlock()
#
## Below is an example to define the print function
# WorkflowCompact$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# WorkflowCompact$lock()
