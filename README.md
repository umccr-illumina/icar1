...
```sh
git clone https://github.com/GIT_USER_ID/icar1
cd icar1
R CMD build .
R CMD check icar1_0.0.1.tar.gz --no-manual
R CMD INSTALL --preclean icar1_0.0.1.tar.gz
```

### Install the package

```R
install.packages("icar1")
```
...
library(devtools)
install_github("GIT_USER_ID/icar1")
```

To install the package from a local file:
```R
install.packages("icar1_0.0.1.tar.gz", repos = NULL, type = "source")
```
